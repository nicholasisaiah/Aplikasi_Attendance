...
async function checkAndLog(promise, label) {
...
async function main() {
  ...
  await checkAndLog(
    supabase.from('announcements').upsert([
      ...
      { title: 'Pengumuman Libur Hari Raya', content: 'Sehubungan dengan hari besar keagamaan, kegiatan belajar mengajar ditiadaan dari tanggal 27-29 Mei 2026.', emoji: '🌙', is_published: true, published_at: new Date().toISOString() },
